...
* Homework through chapter 6 has been graded.
	* Solutions have been emailed too. If you didn't get it and submitted your homework, email me.

* Coursera Maching Learning course: https://www.coursera.org/learn/machine-learning/
* If you are having issues knitting R markdown to PDF, try installing the development version of the `rmarkdown` package (see [this Stackoverflow](http://stackoverflow.com/questions/25856362/pandoc-document-conversion-failed-with-error-43-pdflatex-the-memory-dump-file) post for more information):
