---
title: "IS606 - Foundation for Inference Part 2"
...
* The October 22nd meetup will need to rescheduled.
* Added links to the videos from the Github page.
* Homework up to chapter 3 graded.
* Labs look great! I am really happy to see so many of you trying to use `ggplot2` for the figures.


## Meetup Presentations

* Christophe Hunt (4.3)
* Charley Farrai (4.13, 4.25)
...
<iframe src="../R/SamplingDistribution/index.html" height='800' width='700'></iframe>
