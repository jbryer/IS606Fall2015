...
* Meetup schedule for the rest of the semester.
	* No meetup November 26 (Happy Thanksgiving!)
	* Meetup on Wednesday, December 2nd for Bayesian Analysis.
	* No meetup on December 10th.
	* Final meetup on December 17th!
* If you did a presentation and don't see your grade, email me.
* Focus on Chapters 2 and 5 from Kruschke on Bayesian Analysis.
* If you signed up for a presentation on December 3rd and can't make it on the 2nd, or are not signed up at all, let me know. One option is to pick any problem from the semester and pre-record your presentation. This will serve as good review for the final exam.

## Meetup Presentations

* Lara Burford (8.1) [Slides](http://rpubs.com/Lolly6580/127357), [Presentation](https://www.wevideo.com/hub/#media/ci/515645582)
* Keith Folsom (8.3)
* Nicholas Capofari
* Edwige Talla Badjio (8.7)
* Igor Balagula (8.17)
...
print(xtable(lm.out2), type='html')
anova.poverty2 <- anova(lm.poverty)
